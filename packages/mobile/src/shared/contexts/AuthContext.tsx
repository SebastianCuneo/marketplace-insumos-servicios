...
import { authenticateUser, getUserById, HARDCODED_USERS } from '../data/hardcodedUsers.ts';

// Storage compatible con Web y Mobile
const storage = {
...
export const AuthProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    const savedUserId = storage.getItem('currentUserId');
    if (savedUserId) {
