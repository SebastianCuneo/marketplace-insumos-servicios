...
import { SERVICE_STATES, ServiceState, isValidTransition, canReceiveQuotes } from '../constants/serviceStates.ts';
import { mockServicios, mockCotizaciones, mockOfertasInsumos } from '../data/mockData.ts'; 
